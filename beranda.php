...
<html lang="en">
    <head>
		...
		<meta name="keywords" content="MA ANNUR"/>
                        ...
                        <div class="collapse navbar-collapse" id="menu">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#home" id="link-home">Halaman Utama</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
								...
								<div class="card">
									...
									<form id="form-daftar">
										<div class="card-body">
											...
											<div class="form-row">
												<label for="asal">JENJANG PENDIDIKAN</label>
											...
											<img class="p-b-5" id="captcha" src="securimage/securimage_show.php" alt="CAPTCHA Image" style="height:70px" /><br>
												...
												<div class="form-group col-md-6">
													<input class="form-control" type="text" name="kodepengaman" placeholder="Masukan kode captcha" required>
												</div>
							...
							<div class="col-sm-6">
                               ...
                               <p align="center">
                                    <img src="assets/binaumat.jpeg" align="center" width="700" style="max-width: 100%" />
                                </p>
                ...
                <section id="tentang">
                    <div class="container">
                        ...
                        <div class="row">
							...
							<div class="col-sm-6">
                               <p align="center">
                                    <img src="assets/binaumat.jpeg" align="center" width="700" style="max-width: 90%" />
                                </p>
                            </div>
                        </div>
                    </div>
...
<?php } ?>
                <section class="bg-light statistik" id="statistik">
                    <div class="container">
                        ...
                        <h6 class="text-center">Peserta Didik Baru <?= $setting['nama_sekolah'] ?> Tahun 2023</h6>
                        <div class="row mt-12">
                            <div class="col-sm-6">
                                <div class="card mt-2">
