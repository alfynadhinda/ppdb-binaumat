...
crossorigin="anonymous"></script>
  ...
  <div class="main-sidebar sidebar-style-2 pb-2">
          <aside id="sidebar-wrapper">
            
            <div class="sidebar-brand bg-info">
              <img class="mt-2" src="../<?= $setting['logo_ppdb'] ?>" width="37%" alt="LOGO">&nbsp;
            </div>
			<div class="menu-header">
			
				<ul class="pt-5">
					<li>
						<a style="color:#f9f9f9" href="." class="btn-logout">
							<span class="fas fa-home "></span><br>Home
						</a>
					</li>
					<li>
						<a style="color:#f9f9f9" class="btn-logout" href="?pg=setting">
							<span class="fas fa-user-cog "></span><br>Setting
						</a>
					</li>
					<li>
						<a style="color:#f9f9f9" href="logout.php" class="btn-logout"> <span class="fas fa-sign-out-alt  "></span><br>Keluar</a>
					</li>
				</ul>
			</div>
